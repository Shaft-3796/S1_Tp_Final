...
void EnemyBase_Render(Enemy *self)
{
    ...
    pos_frame.x += BASE_ENEMY_LIFE_BAR_OFFSET_X;
    pos_frame.y += BASE_ENEMY_LIFE_BAR_OFFSET_Y;
    ...
    pos_content.x += BASE_ENEMY_LIFE_BAR_OFFSET_X;
    pos_content.y += BASE_ENEMY_LIFE_BAR_OFFSET_Y;
