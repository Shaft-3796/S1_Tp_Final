...
#define ENEMY_LIFE_BAR_SIZE_MULTIPLIER 40.f
#define WAVE_SIZE_MULTIPLIER 75.f
/* --- Offsets for enemies life bar --- */
#define BASE_ENEMY_LIFE_BAR_OFFSET_X -0.4f
#define BASE_ENEMY_LIFE_BAR_OFFSET_Y 1.f
#define AUTO_ENEMY_LIFE_BAR_OFFSET_X -0.4f
#define AUTO_ENEMY_LIFE_BAR_OFFSET_Y 1.2f
#define BOMB_ENEMY_LIFE_BAR_OFFSET_X -0.4f
#define BOMB_ENEMY_LIFE_BAR_OFFSET_Y 1.2f
#define BOSS1_ENEMY_LIFE_BAR_OFFSET_X -0.4f
#define BOSS1_ENEMY_LIFE_BAR_OFFSET_Y 1.4f
#define BOSS2_ENEMY_LIFE_BAR_OFFSET_X -0.4f
#define BOSS2_ENEMY_LIFE_BAR_OFFSET_Y 1.4f
#define RAFALE_ENEMY_LIFE_BAR_OFFSET_X -0.4f
#define RAFALE_ENEMY_LIFE_BAR_OFFSET_Y 1.f
#define REVERT_ENEMY_LIFE_BAR_OFFSET_X -0.4f
#define REVERT_ENEMY_LIFE_BAR_OFFSET_Y 1.f
#define SIN_ENEMY_LIFE_BAR_OFFSET_X -0.4f
#define SIN_ENEMY_LIFE_BAR_OFFSET_Y 1.2f
#define TELEPORT_ENEMY_LIFE_BAR_OFFSET_X -0.4f
#define TELEPORT_ENEMY_LIFE_BAR_OFFSET_Y 1.f
#define TRIANGLE_ENEMY_LIFE_BAR_OFFSET_X -0.4f
#define TRIANGLE_ENEMY_LIFE_BAR_OFFSET_Y 1.f
